function [GPD_RL,GPD_conf,CDF,CDF_prob,Num_Points,Percentile,res]=GPD_FIT_NO_FIG(data,raw_length,return_period_array,type); 
%Derived from Coles 2001
%original Code from J. Allan and K. Serafin. 
%Modified by J. Shope 2019


%Same as GPD_FIT_FIG but does not output figures
